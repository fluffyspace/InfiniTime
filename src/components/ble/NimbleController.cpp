  ...
  switch (event->type) {
    ...
    case BLE_GAP_EVENT_SUBSCRIBE:
      ...
      if (event->subscribe.reason == BLE_GAP_SUBSCRIBE_REASON_TERM) {
        ...
        shortcutService.UnsubscribeNotification(event->subscribe.attr_handle);
        ...
        shortcutService.SubscribeNotification(event->subscribe.attr_handle);
